export default function CreateTripCard() {
  return (
    <div className="group flex cursor-pointer flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-outline-variant p-8 transition-colors hover:bg-surface-container-low">
